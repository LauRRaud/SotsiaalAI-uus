...
export const ANSWER_VERSION = 'm4-text-refs-2';
...
export function renderAnswer(answer, version = LEGACY_ANSWER_VERSION) {
  if (![ANSWER_VERSION, LEGACY_ANSWER_VERSION].includes(version)) throw Object.assign(new Error('unsupported_answer_version'), { code: 'unsupported_answer_version' });
