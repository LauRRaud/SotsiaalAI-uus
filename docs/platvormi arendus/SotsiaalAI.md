...
**06.09 M4 väljundileping v3 on kohalikult teostatud ja kontrollitud.** Viidatud allikaväide ja kasutatud väljavõtete piirang saavad avalduda koos; puhas täpsustus või toeta materjalipiir ei vaja kunstlikku faktiplokki. Versioonid 1 ja 2 ning algsed 6 avaldatud / 2 peatatud päristulemused säilivad. 47 sihttesti, desktopi/mobiili taastamine, lint, i18n ja build läbisid; välismudelikutseid, push'i ja deploy'd selles voorus ei tehtud. [Kohaliku paranduse raport](../audits/rag-v2-m4-b-pilot-2026-09-06.md) eristab muutmata veamustandeid käsitsi koostatud õigetest näidistest ning vormikontrolli semantilisest hinnangust. Järgmise eraldi kinnitatava päriskatse ulatus on kaks peatunud juhtumit, täieliku toe kontroll ja puuduliku toe/täpsustuse kontroll ET/EN/RU katvusega; käivitusplaani ega uut kvooti ei ole antud. M4 pole tervikuna vastu võetud; senised katselaed, loa lõpp 07.09 kell 08:00 UTC, M2/M2.3 kinnitused ja seitse lahtist juhtumit säilivad.
