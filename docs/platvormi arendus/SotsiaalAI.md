...
**06.09 M4-B järelparandused on kohalikult kontrollitud.** Tavavestluses taastub ka peatatud küsimus koos veateatega; saatmiseelne pakett ja vigane mustand säilivad kaitstult, viited saavad ühe versioonitud kuvakuju ning vastamisjuhis kannab serveri sihtkeelt ja allika ulatust. 38 sihttesti, tegelik desktopi/mobiili taastamisrada ja tootmisbuild läbisid; uusi välismudelikutseid ega serverimuudatusi ei tehtud. Luna keele ja väidete sisuline paranemine jääb järgmise päriskatse tõendada. Järgmine samm on omaniku eraldi kinnitus [auditis kirjeldatud plaanile](../audits/rag-v2-m4-b-pilot-2026-09-06.md): samad kaheksa küsimust, kuni 8 vastamiskatset, 0 uut embedding'ut olemasolevate lubatud vektoritega ja kuni 0,16 USD, lõpp 07.09 kell 08:00 UTC. Push/deploy ja uus jooks ootavad luba. Algse jooksu 7 vastust, neljanda katse tõendilünk, vana 8/8 ledger ning M2/M2.3 kinnitused ja seitse lahtist juhtumit säilivad.
