...
**06.09 M4-B parandatud pärisregressioon on lõpetatud.** Omaniku loal serverisse viidud koodil `e7532b8ba` tehti samade kaheksa küsimusega 8 vastamiskatset ja 0 uut embedding'ut: 6 vastust avaldati, 2 peatati. Mõlemad EN vastused on nüüd inglise keeles, avaldatud viited on puhtad ning mõlemad veapöörded taastuvad; kõik 7 võrreldavat allikapaketti olid samad. Avaldamine langes siiski 7/8-lt 6/8-le: kaks materjali piiri kirjeldavat plokki said `factual=true` ja tühjad viited. Järgmine sidus tööots on selle väljundilepingu ning allika rolli/ulatuse täpsus, kasutades salvestatud mustandeid kohaliku regressiooni alusena. M4 pole avalikuks kasutuseks vastu võetud; uut kaheksa küsimuse jooksu ega jätkuvestluse katset ei alustata automaatselt. [Enne/pärast aruanne](../audits/rag-v2-m4-b-pilot-2026-09-06.md) säilitab algse neljanda katse tõendilünga, mõlema jooksu mõõtmised ja muutmata vana ledgeri. Mõlema plaani katselaed on täis; loa lõpp jäi 07.09 kell 08:00 UTC. M2/M2.3 kinnitused ja seitse lahtist juhtumit säilivad.
